...
class StPicoCutsBase : public TNamed
{
 public:
  ...
  bool isGoodRunHFT(StPicoEvent const * const picoEvent) const; //Vanek
  ...
  bool isTPCHadron(StPicoTrack const * const trk, int pidFlag) const;
	bool hasGoodTPCnSigma(StPicoTrack const *trk, int pidFlag) const;
  ...
  bool isTPCProton(StPicoTrack const *trk) const;
	...
	bool hasGoodNHitsFitnHitsMax(StPicoTrack const *trk) const; //Vanek

	bool hasGoodDCAMaxGlob(StPhysicalHelixD helix, StThreeVectorF pVtx) const; //Vanek
  ...
  bool isTOFPionB(StPicoTrack const *trk, float B) const; //new argument for magnetic field "float B", SL16j, Vanek
  bool isTOFKaonB(StPicoTrack const *trk, float B) const;
  bool isTOFProtonB(StPicoTrack const *trk, float B) const;
  ...
  //      - primary hadrons 
  //      - secondarys from charm decays (as an approximation)
  bool isHybridTOFPionB(StPicoTrack const *trk, float B) const; //new argument for magnetic field "float B", SL16j, Vanek
  bool isHybridTOFKaonB(StPicoTrack const *trk, float B) const;
  bool isHybridTOFProtonB(StPicoTrack const *trk, float B) const;
  ...
  void setCutPrimaryDCAtoVtxMax(float f);
	...
	void setCutDCAMaxGlob(float f); //for global DCA cut, Vanek
  ...
  void setCutTOFDeltaOneOverBeta(float f, int pidFlag);
	float getCutTOFDeltaOneOverBeta(int pidFlag);
  ...
  float getTofBetaBase(StPicoTrack const* const trk, float B) const; //new argument for magnetic field "float B", SL16j, Vanek

  // -- calculate beta of track -- for primary particles
  float getTofBeta(StPicoTrack const* const trk, float B) const; //new argument for magnetic field "float B", SL16j, Vanek
...
private:
  ...
  float mPrimaryDCAtoVtxMax;         // used for primary selection for TOF Beta recalculation
	...
	float mDCAMaxGlob;  //for global DCA cut, Vanek
...
inline void StPicoCutsBase::setCutDCAMaxGlob(float f) { mDCAMaxGlob = f; }
...
inline float StPicoCutsBase::getCutTOFDeltaOneOverBeta(int pidFlag)						{ return mTOFDeltaOneOverBetaMax[pidFlag]; } //getter for preset delta 1/beta cut
...
inline bool StPicoCutsBase::hasGoodTPCnSigmaPion(StPicoTrack const *trk) const { return hasGoodTPCnSigma(trk, StPicoCutsBase::kPion); }
inline bool StPicoCutsBase::hasGoodTPCnSigmaKaon(StPicoTrack const *trk) const { return hasGoodTPCnSigma(trk, StPicoCutsBase::kKaon); }
inline bool StPicoCutsBase::hasGoodTPCnSigmaProton(StPicoTrack const *trk) const { return hasGoodTPCnSigma(trk, StPicoCutsBase::kProton); }
...
inline bool StPicoCutsBase::isTOFKaonB(StPicoTrack const *trk, float B)   const { float tofBeta = getTofBeta(trk, B);  
                                                                        return isTOFHadron(trk, tofBeta, StPicoCutsBase::kKaon); }
inline bool StPicoCutsBase::isTOFProtonB(StPicoTrack const *trk, float B) const { float tofBeta = getTofBeta(trk, B);  
                                                                        return isTOFHadron(trk, tofBeta, StPicoCutsBase::kProton); }
...
inline bool StPicoCutsBase::isHybridTOFPionB(StPicoTrack const *trk, float B)   const { float tofBeta = getTofBeta(trk, B);  //new argument for magnetic field "float B", SL16j, Vanek
                                                                            return isHybridTOFHadron(trk, tofBeta, StPicoCutsBase::kPion); }
inline bool StPicoCutsBase::isHybridTOFKaonB(StPicoTrack const *trk, float B)   const { float tofBeta = getTofBeta(trk, B);  
                                                                              return isHybridTOFHadron(trk, tofBeta, StPicoCutsBase::kKaon); }
inline bool StPicoCutsBase::isHybridTOFProtonB(StPicoTrack const *trk, float B) const { float tofBeta = getTofBeta(trk, B);  
                                                                              return isHybridTOFHadron(trk, tofBeta, StPicoCutsBase::kProton); }
